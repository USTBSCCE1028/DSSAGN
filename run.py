...
class Experiment:
    ...
    def train_and_eval(self):
        ...
        model = KGE(self.dataset, self.ent_vec_dim, do_batch_norm=self.do_batch_norm,
...
if __name__ == '__main__':
    set_fixed_seed(seed=2024)
    experiment = Experiment(num_epochs=5, test_interval=10, batch_size=128, learning_rate=0.0005, ent_vec_dim=200,
                            ...
                            model_dir='kg_embeddings', dataset_name='CommonsenseQA', load_from='', decay_rate=1.0)
